...
public class EmailConstant {
    ...
    public static final String USERNAME = "fakeEmail@gmail.com";
    public static final String PASSWORD = "fakePassword";
    public static final String FROM_EMAIL = "support@appteam.com";
